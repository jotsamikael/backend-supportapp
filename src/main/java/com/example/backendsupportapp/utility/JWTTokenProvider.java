package com.example.backendsupportapp.utility;
...
//METHOD RESPONSIBLE OF GENERATING TOKEN
    public String generateJwtToken(UserPrincipal userPrincipal){
        String[] claims = getClaimsFromUser(userPrincipal);

        return JWT.create().withIssuer(SecurityConstant.ALPHA_CENTAURI_LLC).withAudience(SecurityConstant.ALPHA_CENTAURI_ADMINISTRATION)
    ...
    private JWTVerifier getJWTVerifier() {
        ...
        try{
            ...
            verifier = JWT.require(algorithm).withIssuer(SecurityConstant.ALPHA_CENTAURI_LLC).build();
