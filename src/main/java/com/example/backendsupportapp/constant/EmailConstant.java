...
public class EmailConstant {
    ...
    public static final String USERNAME = "jotsamikael@gmail.com";
    public static final String PASSWORD = "wbszsduaiffcugvh";
    public static final String FROM_EMAIL = "support@getarrays.com";
    public static final String CC_EMAIL = "";
    public static final String EMAIL_SUBJECT = "ALPHA CENTAURI, LLC - New Password";
